...
Java_com_changsune_changsu_yeontalk_screens_common_videokit_VideoKit_StopProcess(JNIEnv *env, jobject obj){
    stop_process = 1;
}


JNIEXPORT jint JNICALL
Java_com_changsune_changsu_yeontalk_screens_common_videokit_VideoKit_RunCommand(JNIEnv *env,
                                                    jobject obj/* this */,
                                                    jobjectArray args) {
    int result = 1;
    //0 is no error
