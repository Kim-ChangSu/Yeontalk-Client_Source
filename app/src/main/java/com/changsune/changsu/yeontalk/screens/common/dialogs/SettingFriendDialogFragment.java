...
public class SettingFriendDialogFragment extends DialogFragment {

    private static final String TAG = "SettingFriendDialogFrag";
    ...
    public static SettingFriendDialogFragment newInstance(Listener listener, String string) {

        SettingFriendDialogFragment settingFriendDialogFragment = new SettingFriendDialogFragment();
        settingFriendDialogFragment.mListener = listener;
        settingFriendDialogFragment.mValue = string;
        return settingFriendDialogFragment;

    }

    public static SettingFriendDialogFragment newInstance(Listener listener, String string, String string2) {

        SettingFriendDialogFragment settingFriendDialogFragment = new SettingFriendDialogFragment();
        settingFriendDialogFragment.mListener = listener;
        settingFriendDialogFragment.mValue = string;
        settingFriendDialogFragment.mValue2 = string2;
        return settingFriendDialogFragment;
