...
package com.changsune.changsu.yeontalk.screens.videocall;
...
import com.changsune.changsu.yeontalk.videocall.AppRTCAudioManager;
import com.changsune.changsu.yeontalk.videocall.AppRTCClient;
import com.changsune.changsu.yeontalk.videocall.CpuMonitor;
import com.changsune.changsu.yeontalk.videocall.DirectRTCClient;
import com.changsune.changsu.yeontalk.videocall.PeerConnectionClient;
import com.changsune.changsu.yeontalk.videocall.UnhandledExceptionHandler;
import com.changsune.changsu.yeontalk.videocall.WebSocketRTCClient;
...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
  ...
  public static final String EXTRA_ME_ID = "EXTRA_ME_ID";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    userId = intent.getExtras().getString(EXTRA_USER_ID);
    meId = intent.getExtras().getString(EXTRA_ME_ID);
    webRtcRoomId = intent.getExtras().getString(EXTRA_ROOM_ID);
    userNickName = intent.getExtras().getString(EXTRA_USER_NICKNAME);
      ...
      public void run() {
        if (appRtcClient != null) {
          ...
          if (signalingParameters.initiator) {
            ...
            ChatService.sendMessage(userId + ">" + meId + ">" + "" + ">" + userNickName + ">" + Constants.VIDEO_CALL_TYPE + ">" + webRtcRoomId);
