package com.changsune.changsu.yeontalk.screens.videocallrequest;
...
public class VideoCallRequestActivity extends AppCompatActivity {

    public static final String EXTRA_USER_ID = "EXTRA_USER_ID";
    public static final String EXTRA_USER_NICKNAME = "EXTRA_USER_NICKNAME";
    public static final String EXTRA_WEBRTC_ROOM_ID = "EXTRA_WEBRTC_ROOM_ID";
    ...
    public static void start(Context context, String userId, String userNickName, String webRtcRoomId) {

        Intent intent = new Intent(context, VideoCallRequestActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.putExtra(EXTRA_USER_ID, userId);
        intent.putExtra(EXTRA_USER_NICKNAME, userNickName);
        intent.putExtra(EXTRA_WEBRTC_ROOM_ID, webRtcRoomId);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userNickName = getIntent().getExtras().getString(EXTRA_USER_NICKNAME);
        webRtcRoomId = getIntent().getExtras().getString(EXTRA_WEBRTC_ROOM_ID);

        mTextView = findViewById(R.id.contact_name_call);
        connectButton = findViewById(R.id.button_call_connect);
        disconnectButton = findViewById(R.id.button_call_disconnect);

        mTextView.setText(userNickName);
