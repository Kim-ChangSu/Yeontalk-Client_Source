...
public class InsertFavoriteUseCase extends BaseObservable<InsertFavoriteUseCase.Listener> {

    public interface Listener {
        void onInsertFavoriteUseCaseSucceeded(String string);
        void onInsertFavoriteUseCaseFailed();
    }
    ...
    public void insertFavoriteUseCaseAndNotify(String userIdFrom, String userIdTo) {
        cancelCurrentFetchIfActive();
        mCall = mYeonTalkApi.insertFavorite(userIdFrom, userIdTo);
    ...
    private void notifySucceeded(String string) {
        for (Listener listener : getListeners()) {
            listener.onInsertFavoriteUseCaseSucceeded(string);
        }
    }

    private void notifyFailed() {
        for (Listener listener : getListeners()) {
            listener.onInsertFavoriteUseCaseFailed();
        }
    }
}
