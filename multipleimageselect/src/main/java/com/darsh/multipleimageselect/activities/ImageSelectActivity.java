...
//                }
                ...
                mTextView_title.setText(countSelected + " / " + Constants.limit);
                mTextView_ok.setVisibility(View.VISIBLE);
                ...
                if (countSelected == 0) {
                    mTextView_title.setText("사진");
                    mTextView_ok.setVisibility(View.GONE);
                }
            }
        });
    }
                    ...
                    case Constants.FETCH_COMPLETED: {
                        ...
                        if (adapter == null) {
                            ...
                            if (actionMode != null) {
                                ...
                                actionMode.setTitle(countSelected + " / " + Constants.limit);
                            }
                        }
                        break;
                    }
    ...
    private void setUpToolbar() {
        mTextView_ok = findViewById(R.id.textview_ok_toolbar_id);
        mTextView_title = findViewById(R.id.txt_toolbar_title);
        mTextView_title.setText("사진");
